...
class MPU_9250:	
	...
	MPU9250_GYRO_FS_SEL_MASK = 0x3
	MPU9250_GYRO_FCHOICE_MASK = 0x3
	...
	MAG_CTRL_OP_MODE_MASK = 0xF

	AK8963_ST1_DRDY_BIT = 0
	...
	def read16U(self, register1, register2):
		bytes = bus.read_i2c_block_data(self.address, register1, 2)
		return (bytes[0] << 8) + (bytes[1])
	def read24U(self, register):
		bytes = bus.read_i2c_block_data(self.address, register, 3)
		return (bytes[0] << 16) + (bytes[1] << 8) + bytes[2]

	def get_gyro_reg(self):
		gyro_x = self.read16U(MPU_9250.MPU9250_GYRO_XOUT_H, MPU_9250.MPU9250_GYRO_XOUT_L)
		gyro_y = self.read16U(MPU_9250.MPU9250_GYRO_YOUT_H, MPU_9250.MPU9250_GYRO_YOUT_L)
		gyro_z = self.read16U(MPU_9250.MPU9250_GYRO_ZOUT_H, MPU_9250.MPU9250_GYRO_ZOUT_L)
		return [gyro_x,gyro_y,gyro_z]

	def get_accel_reg(self):
		accel_x = self.read16U(MPU_9250.MPU9250_ACCEL_XOUT_H, MPU_9250.MPU9250_ACCEL_XOUT_L)
		accel_y = self.read16U(MPU_9250.MPU9250_ACCEL_YOUT_H, MPU_9250.MPU9250_ACCEL_YOUT_L)
		accel_z = self.read16U(MPU_9250.MPU9250_ACCEL_ZOUT_H, MPU_9250.MPU9250_ACCEL_ZOUT_L)
